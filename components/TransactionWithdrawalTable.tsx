...
const TransactionWithdrawalTable = async () => {
  // const {
  //   borderColor,
  //   backgroundColor,
  //   textColor,
  ...
  const userlist = await getUserWithdrawalTransaction({
            ...
            <TableCell className="">
              <div className={cn("category-badge")}>
                <div
                  className={cn(
                    "size-2 rounded-full",
                    user.status === "Successful" ? "bg-green-700" : "bg-red-700"
                  )}
                />
                <p
                  className={cn(
...
export default TransactionWithdrawalTable;
