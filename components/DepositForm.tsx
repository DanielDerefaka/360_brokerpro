                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-2">
                      ...
                      <div className="space-y-1 w-full flex justify-center">
                        ...
                        {selectedCoin === "usdt" && (
                         <Image src="/coin/usdt.jpg" alt="wallet" className="w-[400px] mt-4" width={100} height={50} />
                         )}
                        {selectedCoin === "btc" && (
                          <Image src="/coin/btc.jpg" alt="wallet"  className="w-[400px]"  width={100} height={50} />
                        )}
                        {selectedCoin === "trx" && (
                          <Image src="/coin/trx.jpg" alt="wallet"  className="w-[400px]"   width={100} height={50} />
                        )}
                      </div>
